				...
				<ul class="unit">
					...
					<%-- <c:forEach var="watch" items="${watch }"> --%>
					   ...
					   <ul class="cart-header">
							<li class="ring-in"><a href="single.jsp" ><img src="images/${watch.img}<!-- images/c-1.jpg -->" class="img-responsive zoom-img<!-- img-responsive -->" alt=""></a>
							</li>
							<li><span class="name">${watch.watchName }</span></li>
							<li><span class="cost">￥${watch.price }</span></li>
							<li><span>包邮</span>
							<p>快递2-3天即可到达</p></li>
						</ul>
					<%-- </c:forEach> --%>
