		...
		<div class="container">
			...
			<div class="col-md-3 header-right"> 
				...
				<!-- 搜索功能 -->
					...
					<input type="text" name="watchName" value="搜索" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Search';}">
		...
		<div class="container">
			<div class="prdt-top">
				<div class="col-md-9 prdt-left">
					...
					<!-- 循环列出商品  从数据库中取出数据以及图片 -->
					<c:forEach var="watch" items="${watchList }" >
						<div class="col-md-4 product-left p-left">
							<div class="product-main simpleCart_shelfItem">
								<a href="../singleWatch?watchName=${watch.watchName}">	<img class="img-responsive zoom-img" src="images/${watch.img}<%-- ${watch.img} --%><%-- ${ctx }/images/${watch.img} --%>" alt="" /></a>
								<div class="product-bottom">
									<h3>${watch.watchName }</h3>
									<p>马上查看</p>
									<h4><a class="item_add" href="#"><i></i></a> <span class=" item_price">价格：${watch.price }</span></h4>
								</div>
						...
						<div class="clearfix"></div>
						<div align="center">
					<a href="../searchP.do?page=1">首页</a>&nbsp;&nbsp;
					<c:if test="${page.dpage!=1 }">
					<a href="../searchP.do?page=${page.dpage-1}">上一页</a>&nbsp;&nbsp;
					</c:if>
					<c:if test="${page.dpage!=page.totalpage }">
					<a href="../searchP.do?page=${page.dpage+1}">下一页</a>&nbsp;&nbsp;
					</c:if>
					<a href="../searchP.do?page=${page.totalpage}">尾页</a>
						</div>
					</div>	 
				</div>	
