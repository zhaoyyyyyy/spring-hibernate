...
public class UserLogin {
	...
	/*@OneToMany(mappedBy="UserLogin",targetEntity=Log.class,cascade=CascadeType.ALL)
	public Set<Log> getlSet() {
		return lSet;
	}
	public void setlSet(Set<Log> lSet) {
		this.lSet = lSet;
	}
	@OneToMany(mappedBy="UserLogin",targetEntity=Order.class,cascade=CascadeType.ALL)
